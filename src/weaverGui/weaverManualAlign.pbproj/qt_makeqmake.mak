...
QMAKE    = /usr/bin/qmake
weaverManualAlign.pbproj/project.pbxproj: weaverManualAlign.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o weaverManualAlign.pbproj/project.pbxproj weaverManualAlign.pro
